...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background...
        'outline' => 'bg-surface disabled:bg-secondary', //'bg-white dark:bg-white/10 dark:disabled:bg-white/[7%]',
    ...
    ->add(match ($variant) { // Border...
        'outline' => 'shadow-xs border border-border focus:border-accent focus:ring-2 focus:ring-accent/30', /* 'shadow-xs border-zinc-200 border-b-zinc-300/80 disabled:border-b-zinc-200 dark:border-white/10 dark:disabled:border-white/5', */
        'filled'  => 'border-0',
    })
