        ...
        <div class="flex gap-2 items-center justify-between sm:hidden">
            ...
            @if ($paginator->onFirstPage())
                <span
                    ...
                    {{-- text-gray-600 bg-white border border-gray-300 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-600 --}}
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span
                                ...
                                aria-hidden="true">
                                {{-- text-gray-500 bg-white border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400 --}}
